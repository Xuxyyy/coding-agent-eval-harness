...
The following records preserve earlier implementation milestones. Their
profile IDs, schema versions, case counts, and commands are historical rather
than current usage guidance:

- [User-centered foundation verification](foundation-verification.md)
- [Structured trial evidence verification](trial-evidence-verification.md)
